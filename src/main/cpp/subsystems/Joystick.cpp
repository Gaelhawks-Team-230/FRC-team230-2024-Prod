                        ...
                        double kx, double ky, double kz)
{
    ...
    xf = xf + xfdot * Constants::LOOPTIME;
    yf = yf + yfdot * Constants::LOOPTIME;
    zf = zf + zfdot * Constants::LOOPTIME;
...
double Joystick::AxisShaping(double rawReading, double deadband, double shapingSlope)
{
    ...
    l_modifiedReading = fmax(((fabs(rawReading) - deadband) / (1.0 - deadband)), 0.0) * MathUtil::Sign(rawReading);
...
void Joystick::Analyze()
{
    ...
    flightctrl_shape_x = AxisShaping(flightctrl_raw_x, Constants::FlightCtrlAxis::X_DEADBAND, Constants::FlightCtrlAxis::X_SHAPING);
    // Convert to std frame of reference
    ...
    flightctrl_scale_x = ScaleCmd(flightctrl_shape_x, MathUtil::Limit(Constants::Swerve::XY_SFACTOR_LOW, Constants::Swerve::XY_SFACTOR, Constants::Swerve::XY_SFACTOR_LOW + (Constants::Swerve::XY_SFACTOR - Constants::Swerve::XY_SFACTOR_LOW) * k));
    flightctrl_scale_y = ScaleCmd(flightctrl_shape_y, MathUtil::Limit(Constants::Swerve::XY_SFACTOR_LOW, Constants::Swerve::XY_SFACTOR, Constants::Swerve::XY_SFACTOR_LOW + (Constants::Swerve::XY_SFACTOR - Constants::Swerve::XY_SFACTOR_LOW) * k));
    flightctrl_scale_r = ScaleCmd(flightctrl_shape_r, MathUtil::Limit(Constants::Swerve::R_SFACTOR_LOW, Constants::Swerve::R_SFACTOR, Constants::Swerve::R_SFACTOR_LOW + (Constants::Swerve::R_SFACTOR - Constants::Swerve::R_SFACTOR_LOW) * k));
